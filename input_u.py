...
tiger_img= pygame.image.load(os.path.join('Assets', 'tg3.png'))
...
def input_u():
    ...
    while True:
        ...
        surf = font2.render(u,True,'black')
        vd_title = font1.render("Enter initial velocity of Tiger (u):",True,'black')
        WIN.blit(vd_title, (tb1.x-140, tb1.y -35))
